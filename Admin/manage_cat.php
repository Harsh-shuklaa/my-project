					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>"><i class="fa-solid fa-pencil fa-lg"style="color:MediumSeaGreen;"></i> Edit</a></button>
								<button style="color:red;" class="btn"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>"> <i class="fa-solid fa-trash-can fa-lg"style="color:red;"></i>Delete</a></button></td>
							</tr>
							<?php
						}
					?>
