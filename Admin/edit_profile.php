...
<a href="logout_confirm.php" class="btn btn-secondary">logout <i class="fa-solid fa-right-from-bracket"></i></a>
    ...
    <center><h4 class="btn btn-dark"><b>Edit Profile</b></h4><br></center>
		<div class="row">
			...
			<div class="col-md-4">
				<form action="update.php" method="post">
					...
					<div class="form-group">
						...
						<input type="text" name="email" class="form-control"placeholder="Enter your e-mail :"  value="<?php echo $email;?>">
					</div>
					<div class="form-group">
						<label for="mobile">Mobile:</label>
						<input type="text" name="mobile" class="form-control"placeholder="Enter your mobile no. :" value="<?php echo $mobile;?>">
					</div>
					<br>
