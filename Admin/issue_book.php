...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <br><br>
<center><h4 class= "btn btn-dark"><b>Issue Book</b></h4><br></center>
		<div class="row">
			...
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						...
						<input type="text" name="book_name"  placeholder ="type book name..... "class="form-control" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="book_no" placeholder ="Enter Book No. :" class="form-control" required>
					</div>
					<div class="form-group">
						<label for="student_id">Student ID:</label>
						<input type="text" name="student_id" placeholder ="Enter Student ID :" class="form-control" required>
					</div> 
					<div class="form-group">
