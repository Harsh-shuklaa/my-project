...
background-blend-mode:darken;background-size:contain; "> 
    <br>
    <center><h4 class="btn btn-dark"><b>Manage Books</b></h4><br></center>
    <br>
		<div class="row">
					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn" name=""><a href="edit_book.php?bn=<?php echo $row['book_no'];?>"><i class="fa-solid fa-pencil fa-lg"style="color:MediumSeaGreen;"></i> Edit</a></button>
								<button class="btn"><a href="delete_book.php?bn=<?php echo $row['book_no'];?>" ><i class="fa-solid fa-trash-can fa-lg"style="color:red;"></i> Delete</a></button></td>
							</tr>
							<?php
						}
					?>
