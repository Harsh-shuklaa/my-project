...
background-blend-mode:darken;background-size:contain; "> 
    <br>
    <center><h4 class="  btn k"><b>Add a new Book</b></h4><br></center>
		<div class="row">
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<input type="text" name="book_author" class="form-control"placeholder="Enter  Author ID :"required >
					</div>

					<div class="form-group">
						<label for="mobile">Category ID:</label>
						<input type="text" name="book_category" class="form-control"placeholder="Enter book Category ID :" required>
					</div>
					<div class="form-group">
						<label for="mobile">Book Number:</label>
						<input type="text" name="book_no" class="form-control"placeholder="Enter Book No. :" required>
					</div>
					<div class="form-group">
						<label for="mobile">Book Price:</label>
						<input type="text" name="book_price" class="form-control"placeholder="Enter  Book Price :" required>
					</div><br>
