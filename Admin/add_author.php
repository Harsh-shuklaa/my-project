...
<a href="logout_confirm.php" class="btn btn-secondary">logout <i class="fa-solid fa-right-from-bracket fa-lg"></i></a>
</ul>
		</div>
	</nav>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <center><h4  class="btn "><b>Add Author</b></h4><br></center>
		<div class="row">
			...
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						...
						<input type="text" class="form-control"placeholder="type author name....." name="author_name" required>
					</div>
                    <br>
